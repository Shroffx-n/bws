// background.js - Chrome version with tab groups support
...
// Create session object from windows (with tab groups support)
...
console.log("Portab background script (Chrome) loaded");